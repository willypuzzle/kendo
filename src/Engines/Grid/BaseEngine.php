...
namespace Willypuzzle\Kendo\Engines\Grid;
 ...
 */
abstract class BaseEngine implements KendoGridEngineContract
{
    /**
    ...
    protected function render($object = false)
    {
        ...
        if (isset($this->transformer)) {
            $fractal = app('kendo_grid.fractal');
        ...
        return new JsonResponse($output, 200, config('kendo_grid.json.header', []), config('kendo_grid.json.options', 0));
    }
    ...
    {
        return !!config('kendo_grid.search.case_insensitive', false);
    }
    ...
    {
        config(['kendo_grid.search.smart' => $bool]);
    ...
    {
        return !!config('kendo_grid.search.smart', true);
    }
    ...
    {
        return !!config('kendo_grid.search.use_wildcards', false);
    }
